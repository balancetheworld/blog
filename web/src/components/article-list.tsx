...
import { FileText, ArrowRight, Calendar, Eye, Heart, Clock, Flame, Search, X, Tag } from "lucide-react"
...
// Generate href based on article type (posts use slug)
function getArticleHref(article: Article): string {
  if (article.slug) {
    return `/article/${article.slug}`
  }
  // Fallback for notes if they were included
  if (article.nid) {
...
// Get title from translations based on locale
...
// Get summary from translations based on locale
